...
<div align="center" class="main">
	<table align="center" style="width: 500px;">
		<?php 
			$sqlF = "SELECT DISTINCT missatge.idUsusariReceptor idUsusariReceptor,idUsusariEmisor, idMissatge,imgProfile , nomUsuari  from missatge join usuari where (missatge.idUsusariEmisor = '$idUser' or missatge.idUsusariReceptor = '$idUser') 
			...
			if ($resultF->num_rows > 0) {
				while ($rowF = $resultF->fetch_assoc()) {
					...
					$idMiss = $rowF['idMissatge'];
					if($rowF['idUsusariReceptor'] == $idUser){
						$idUs = $rowF['idUsusariEmisor'];
					}else{
						$idUs = $rowF['idUsusariReceptor'];
					}
					...
					<tr>
						...
						<th align="left" >
							<p align="left"> <?php echo '<a href="mensaje.php?user='.$idUs.'"">'; ?><?php echo $nomSeguidor; ?></a></p>
						</th>
					</tr>
			<?php
				}
